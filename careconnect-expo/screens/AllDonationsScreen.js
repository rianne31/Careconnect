  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>All Donations (Admin)</Text>
        <Text style={styles.description}>
          This page lists all donations made by users. Use this to monitor and manage contributions.
        </Text>
      </View>
      <FlatList
        data={donations}
        ...
        renderItem={({ item }) => (
          <View style={styles.donationItem}>
            <Text>Donor: {item.donor_name}</Text>
